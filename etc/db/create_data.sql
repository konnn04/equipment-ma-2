...
VALUES ('Nguyen', 'Van A', 'admin', '1', 'admin1@example.com', '1234567890', 1, 1),     -- ADMIN
...
INSERT INTO Equipment_Maintenance (equipment_id, maintenance_id, technician_id, description, result, repair_name,
                                   repair_price, inspection_date)
VALUES (1, 1, 2, 'Kiểm tra laptop, hoạt động tốt', 1, 'None', 0, '2023-10-01 10:00:00'),            -- NORMALLY
